...
<body class="w-full md:max-w-3xl lg:max-w-5xl mx-auto min-h-screen bg-gray-50 md:shadow-2xl md:border-x border-gray-200 transition-all duration-300 pb-20 md:pb-24">
    ...
    <div class="p-4 md:p-8 max-w-2xl mx-auto">
        ...
        <?php if ($step === 1): ?>
            <form method="POST" action="deposit.php" class="bg-white p-6 md:p-10 rounded-2xl shadow-xl border-t-4 border-blue-500">
        ...
        ?>
            <form method="POST" action="deposit.php" enctype="multipart/form-data" class="bg-white p-6 md:p-10 rounded-2xl shadow-xl border-t-4 border-green-500">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
