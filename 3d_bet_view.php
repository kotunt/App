...
<body class="w-full md:max-w-3xl lg:max-w-5xl mx-auto min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 pb-32 md:pb-10 flex flex-col relative">
    ...
    <div class="bg-white dark:bg-slate-800/50 p-4 mx-4 md:mx-8 mt-4 rounded-2xl flex flex-col gap-2 border border-slate-200 dark:border-slate-700/50 shadow-card">
            ...
            <div id="step1" class="animate__animated animate__fadeIn">
                ...
                <div class="px-4 mb-3">
                    <div class="relative">
                        ...
                        <input type="text" id="numberSearch" inputmode="numeric" maxlength="3" oninput="searchNumber(this.value)"
                               placeholder="ဂဏန်းရှာရန် (ဥပမာ ၁၂၃)"
    ...
    <script>
        ...
        function renderChips() {
            ...
            if (!container) return;
            let nums = document.getElementById('bet_number').value.split(/[\s,]+/).filter(n => n.match(/^[0-9]{3}$/));
