...
?>
    ...
    <div id="bottomNavBar" class="fixed bottom-0 left-0 right-0 mx-auto w-full max-w-md md:max-w-3xl lg:max-w-5xl glass dark:bg-gray-800/90 border-t border-white/40 dark:border-gray-700 md:border-x md:rounded-t-4xl flex justify-around py-2 md:py-3 shadow-[0_-4px_24px_rgba(26,66,138,0.12)] md:shadow-[0_-8px_36px_rgba(26,66,138,0.16)] z-50 transition-transform duration-500 transform translate-y-0">
        ...
        <a href="<?= $base_url ?>promotions.php" class="flex flex-col items-center bottom-nav-icon group transition-all <?= $current_page == 'promotions.php' ? 'active' : '' ?>">
            <span class="flex items-center justify-center w-11 h-8 md:w-14 md:h-9 rounded-2xl transition-all <?= $current_page == 'promotions.php' ? 'bg-primary/10 text-primary dark:bg-blue-400/15 dark:text-blue-300' : 'text-gray-500 group-hover:text-primary dark:text-gray-400 dark:group-hover:text-blue-300' ?>"><i class="fas fa-gift text-lg md:text-xl group-hover:scale-110 transition-transform"></i></span>
            <span class="text-[10px] md:text-xs font-semibold mt-0.5 <?= $current_page == 'promotions.php' ? 'text-primary dark:text-blue-300' : 'text-gray-500 dark:text-gray-400' ?>"><?= __('nav_promotions') ?></span>
        </a>
        <a href="<?= $base_url ?>contact.php" class="flex flex-col items-center bottom-nav-icon group transition-all <?= $current_page == 'contact.php' ? 'active' : '' ?>">
            <span class="flex items-center justify-center w-11 h-8 md:w-14 md:h-9 rounded-2xl transition-all <?= $current_page == 'contact.php' ? 'bg-primary/10 text-primary dark:bg-blue-400/15 dark:text-blue-300' : 'text-gray-500 group-hover:text-primary dark:text-gray-400 dark:group-hover:text-blue-300' ?>"><i class="fas fa-headset text-lg md:text-xl group-hover:scale-110 transition-transform"></i></span>
            <span class="text-[10px] md:text-xs font-semibold mt-0.5 <?= $current_page == 'contact.php' ? 'text-primary dark:text-blue-300' : 'text-gray-500 dark:text-gray-400' ?>"><?= __('nav_contact') ?></span>
        </a>
